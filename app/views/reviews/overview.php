...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Reviews overview</h1>
        </div>

        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/reviews/create" class="btn btn--primary">+ New Review</a>
            </div>
        </div>
        ...
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                            ...
                            <?php foreach ($data['reviews'] as $review) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <?= $review->reviewCustomerId ?>
                                    </td>
                                    <td class="int-table__cell"><?= $review->reviewEntityId ?></td>
                                    <td class="int-table__cell"><?= $review->reviewRating ?></td>
                                    <td class="int-table__cell"><?= $review->reviewDescription ?></td>
                                    <td class="int-table__cell"><?= date('d/m/y', ($review->reviewCreateDate)) ?>
                                    </td>
                                    <td class="int-table__cell"><?= $review->reviewIsActive ?></td>
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>reviews/update/{reviewId:<?= $review->reviewId ?>}/" class="btn btn--primary">Edit</a>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['countReviews'] ?> Results</p>
                ...
                <nav class="pagination text-sm" aria-label="Pagination">
                    <ul class="pagination__list flex flex-wrap gap-xxxs">
                        <li>
                            ...
                            $prevPageLink = URLROOT . "reviews/overview/?page=$prevPage";
                        ...
                        <li>
                            ...
                            $nextPageLink = URLROOT . "reviews/overview/?page=$nextPage";
            ...
            <div class="dialog dialog--sticky js-dialog" id="dialog-delete-user-confirmation" data-animation="on">
                <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
                    <div class="text-component">
                        <br>
                        <br>
                        <h4 id="dialog-title-1">Are you sure you want to delete this review?
                        </h4>
                    ...
                    <footer class="margin-top-md">
                        <div class="flex justify-end gap-xs flex-wrap">
                            ...
                            <a class="btn btn--accent" href="<?= URLROOT; ?>reviews/delete/reviewId:<?= $review->reviewId ?>}">Delete</a>
                        </div>
                    </footer>
                </div>
            </div>
