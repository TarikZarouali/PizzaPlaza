...
<div class="toast toast--hidden toast--top-right toast--success js-toast" role="alert" aria-live="assertive" aria-atomic="true">
...
<div class="toast toast--hidden toast--top-right toast--error js-toast" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="flex items-start justify-between">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>reviewscontroller/overview/" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">review</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>screenscontroller/overview/" class="sidenav__link">
