        ...
        <div class="header__container container max-width-lg">
            ...
            <button class="reset user-menu-control" aria-controls="user-menu" aria-label="Toggle user menu">
                <figure class="user-menu-control__img-wrapper radius-50%">
                    <img class="user-menu-control__img" src="<?= URLROOT . 'public/media/profile.jpg' ?>" alt="User picture">
                </figure>
            ...
            <menu id="user-menu" class="menu js-menu">
                <?php if (isset($_SESSION['user'])) : ?>
                    ...
                    <li role="menuitem">
                        <a class="menu__content js-menu__content" href="<?= URLROOT . 'users/usersettings/' ?>">
                    ...
                    <li role="menuitem">
                        <a class="menu__content js-menu__content" href="<?= URLROOT . 'users/logout' ?>">Logout</a>
                    </li>
                <?php else : ?>
                    <!-- Displayed when users is not logged in -->
                    <li role="menuitem">
                        <a class="menu__content js-menu__content" href="<?= URLROOT . 'users/register/' ?>">
                            <svg class="icon menu__icon" aria-hidden="true" viewBox="0 0 16 16">
                                <path d="M8,11c-1.657,0-3-1.343-3-3s1.343-3,3-3s3,1.343,3,3S9.657,11,8,11z M8,6.5c-1.104,0-2,0.896-2,2s0.896,2,2,2s2-0.896,2-2 S9.104,6.5,8,6.5z" />
                            </svg>
                            <span>Register</span>
                        </a>
                    </li>
                    <li role="menuitem">
                        <a class="menu__content js-menu__content" href="<?= URLROOT . 'users/login/' ?>">
                            <svg class="icon menu__icon" aria-hidden="true" viewBox="0 0 16 16">
                                <circle cx="8" cy="4.5" r="2.5" />
                                <circle cx="8" cy="9.5" r="2.5" />
                                <path d="M8,12c-2.757,0-5-2.243-5-5s2.243-5,5-5s5,2.243,5,5S10.757,12,8,12z M8,3.5C6.896,3.5,6,4.396,6,5.5S6.896,7.5,8,7.5 s2,0.896,2,1.999S9.104,10.5,8,10.5s-2-0.896-2-1.999C6,4.396,6.896,3.5,8,3.5z" />
                            </svg>
                            <span>Login</span>
                        </a>
                    </li>
                        ...
                        <li class="header__item">
                            ...
                            <a href="<?= URLROOT ?>homepages/overview/" class="header__nav-btn btn btn--primary">
                                <svg class="icon" viewBox="0 0 24 24">
                                    ...
                                    <path d="M3 3h2v2H3zM2 6h3.586L7 14.414l1.707-1.707L2 4.586V8H0V2h7l1.263 8.579 1.986-1.986L5.586 0h5.828L14 4.586l2.722-1.722 1.986 1.986L14.414 6H21v2h2v2H5.408L4 18.414l-2 2V20h16v-1.586l2-2V6H2z">
                                    </path>
                                </svg>
                            </a>
                        </li>
