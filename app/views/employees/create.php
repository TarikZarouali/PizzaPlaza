        ...
        <div class="bg radius-md shadow-xs">
            <form method="POST" action="<?= URLROOT ?>/employeescontroller/create">
                <div class="grid gap-sm">
                    ...
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="employee-zipcode">Zipcode</label>
                        <input class="form-control width-100" type="text" name="employeeZipCode" id="zipcode" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="employee-role">employee
                            role</label>
                    ...
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="employee-description">Description</label>
                        <textarea class="form-control width-100" name="employeeDescription" id="description"></textarea>
                    </div>
