...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Update selected promotion</h1>
        </div>
            ...
            <nav class="breadcrumbs text-sm" aria-label="Breadcrumbs">
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        <a href="<?= URLROOT ?>promotions/overview/{page:1}}/" class="color-inherit">All Promotions</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="bg radius-md shadow-xs">
            <form method="POST" action="<?= URLROOT ?>promotions/update/{promotionId:<?= $data['promotion']->promotionId ?>}">
        ...
        <div class="bg radius-md shadow-xs">
            <form action="<?= URLROOT; ?>promotions/updateImage/{promotionId:<?= $data['promotion']->promotionId ?>}" method="post" enctype="multipart/form-data">
                <div class="padding-md">
                    <!-- basic form controls -->
                    <fieldset class="margin-bottom-xl">
                        <div class="margin-bottom-sm">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a class="btn btn--accent" href="<?= URLROOT; ?>promotions/deleteImage/{screenId:<?= $image->screenId . ';' . 'promotionId:' . $data['promotion']->promotionId ?>}">Delete</a>
            </div>
        </footer>
    </div>
</div>
