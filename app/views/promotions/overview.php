    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/promotionscontroller/create" class="btn btn--primary">+ New Promotion</a>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Promotions'] as $promotion) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>promotionscontroller/update/<?= $promotion->promotionId ?>/" class="btn btn--primary">Edit</a>
                                        <a href="<?= URLROOT ?>promotionscontroller/delete/<?= $promotion->promotionId ?>/" class="btn btn--primary">Delete</a>
                                    </td>
                                    </td>
                                </tr>
                            <?php endforeach ?>
