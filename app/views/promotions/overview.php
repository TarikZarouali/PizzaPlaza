...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Promotions overview</h1>
        </div>

        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/promotions/create" class="btn btn--primary">+ New Promotion</a>
            </div>
        </div>
        ...
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['promotions'] as $promotion) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>promotions/update/{promotionId:<?= $promotion->promotionId ?>}/" class="btn btn--primary">Edit</a>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['countPromotions'] ?> Results</p>
                ...
                <nav class="pagination text-sm" aria-label="Pagination">
                    <ul class="pagination__list flex flex-wrap gap-xxxs">
                        <li>
                            ...
                            $prevPageLink = URLROOT . "promotions/overview/?page=$prevPage";
                        ...
                        <li>
                            ...
                            $nextPageLink = URLROOT . "promotions/overview/?page=$nextPage";
            ...
            <div class="dialog dialog--sticky js-dialog" id="dialog-delete-user-confirmation" data-animation="on">
                <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
                    <div class="text-component">
                        <br>
                        <br>
                        <h4 id="dialog-title-1">Are you sure you want to delete this promotion?
                        </h4>
                    ...
                    <footer class="margin-top-md">
                        <div class="flex justify-end gap-xs flex-wrap">
                            ...
                            <a class="btn btn--accent" href="<?= URLROOT; ?>promotions/delete/promotionId:<?= $promotion->promotionId ?>}">Delete</a>
                        </div>
                    </footer>
                </div>
            </div>
