                        ...
                        <li class="sidenav__item">
                            <a href="index.html" class="sidenav__link" aria-current="page">
                                <svg class="icon sidenav__icon" aria-hidden="true" viewBox="0 0 16 16">
                                    <g>
                                        <path d="M6,0H1C0.4,0,0,0.4,0,1v5c0,0.6,0.4,1,1,1h5c0.6,0,1-0.4,1-1V1C7,0.4,6.6,0,6,0z M5,5H2V2h3V5z">
                                        </path>
                                        <path d="M15,0h-5C9.4,0,9,0.4,9,1v5c0,0.6,0.4,1,1,1h5c0.6,0,1-0.4,1-1V1C16,0.4,15.6,0,15,0z M14,5h-3V2h3V5z">
                                        </path>
                                        <path d="M6,9H1c-0.6,0-1,0.4-1,1v5c0,0.6,0.4,1,1,1h5c0.6,0,1-0.4,1-1v-5C7,9.4,6.6,9,6,9z M5,14H2v-3h3V14z">
                                        </path>
                                        <path d="M15,9h-5c-0.6,0-1,0.4-1,1v5c0,0.6,0.4,1,1,1h5c0.6,0,1-0.4,1-1v-5C16,9.4,15.6,9,15,9z M14,14h-3v-3h3V14z">
                                        </path>
                                    </g>
                                </svg>
                            ...
                            <a href="settings.html" class="sidenav__link">
                                <svg class="icon sidenav__icon" aria-hidden="true" viewBox="0 0 16 16">
                                    <g>
                                        ...
                                        <path d="M10,2H6C2.7,2,0,4.7,0,8s2.7,6,6,6h4c3.3,0,6-2.7,6-6S13.3,2,10,2z M10,12H6c-2.2,0-4-1.8-4-4s1.8-4,4-4h4 c2.2,0,4,1.8,4,4S12.2,12,10,12z">
                                        </path>
                                    </g>
                                </svg>
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <button class="btn btn--primary" aria-controls="modal-new-customer">+ New promotion</button>
            </div>
        </div>
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        <thead class="int-table__header js-int-table__header">
                            <tr class="int-table__row">
                                ...
                                <th class="int-table__cell int-table__cell--th int-table__cell--sort js-int-table__cell--sort">
                                    <div class="flex items-center">
                                        <span>promotion Createdate</span>
                                </th>
                                <th class="int-table__cell int-table__cell--th text-left">
                                    promotion Enddate
                                </th>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Promotions'] as $promotion) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <input type="hidden" name="productId" value="<?= $promotion->promotionId ?>">
                                    <td class="int-table__cell">
                                        <?= $promotion->promotionName ?></td>
                                    <td class="int-table__cell"><?= $promotion->promotionDescription ?></td>
                                    <td class="int-table__cell"><?= date('d/m/y', $promotion->promotionCreateDate) ?></td>
                                    <td class="int-table__cell"><?= date('d/m/y', $promotion->promotionEndDate) ?></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>promotionscontroller/update/<?= $promotion->promotionId ?>">Edit</a>
                                    </td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>promotionscontroller/delete/<?= $promotion->promotionId ?>">Delete</a>
                                    </td>
...
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="modal-new-customer">
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog" aria-labelledby="modal-title">
        <header class="bg-contrast-lower bg-opacity-50% padding-y-sm padding-x-md flex items-center justify-between">
            <h4 class="text-truncate" id="modal-title">New Promotion</h4>
        ...
        <div class="padding-md">
            <form method="POST" action="<?= URLROOT ?>/promotionscontroller/create">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-promotionName">Promotion Name</label>
                        <input class="form-control width-100%" type="text" name="promotionName" id="modal-customer-promotionName" required>
                    </div>
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-promotionDescription">Promotion Description</label>
                        <input class="form-control width-100%" type="text" name="promotionDescription" id="modal-customer-promotionDescription" required>
                    </div>
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-promotionEndDate">Promotion End Date</label>
                        <input class="form-control width-100%" type="date" name="promotionEndDate" id="modal-customer-promotionEndDate" required>
                    </div>
                </div>
