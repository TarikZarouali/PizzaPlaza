...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Products Overview</h1>
        </div>

        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/products/create/" class="btn btn--primary">+ New Product</a>
            </div>
        </div>
        ...
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            ...
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>products/update/{productId:<?= $product->productId ?>}/"
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['countProducts'] ?> Results</p>
                ...
                <nav class="pagination text-sm" aria-label="Pagination">
                    <ul class="pagination__list flex flex-wrap gap-xxxs">
                        <li>
                            ...
                            $prevPageLink = URLROOT . "products/overview/?page=$prevPage";
                        ...
                        <li>
                            ...
                            $nextPageLink = URLROOT . "products/overview/?page=$nextPage";
            ...
            <div class="dialog dialog--sticky js-dialog" id="dialog-delete-user-confirmation" data-animation="on">
                <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
                    ...
                    <div class="text-component">
                        <br>
                        <br>
                        <h4 id="dialog-title-1">Are you sure you want to delete this product?
                        </h4>
                    ...
                    <footer class="margin-top-md">
                        <div class="flex justify-end gap-xs flex-wrap">
                            ...
                            <a class="btn btn--accent"
                                href="<?= URLROOT; ?>products/delete/productId:<?= $product->productId ?>}">Delete</a>
                        </div>
                    </footer>
                </div>
            </div>
...
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal"
    ...
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog"
        ...
        <div class="padding-md">
            <form method="POST" action="<?= URLROOT ?>/products/create">
                <div class="grid gap-sm">
                    ...
                    <input class="form-control width-100%" type="text" name="productName"
                        id="modal-customer-productName" required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input class="form-control width-100%" type="text" name="productDescription"
                        id="modal-customer-productDescription" required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input class="form-control width-100%" type="text" name="productPrice"
                        id="modal-customer-productPrice" required>
                </div>
