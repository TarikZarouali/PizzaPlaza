                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Products'] as $product) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>productscontroller/update/<?= $product->productId ?>/" class="btn btn--primary">Edit</a>
                                        <a href="<?= URLROOT ?>productscontroller/delete/<?= $product->productId ?>/" class="btn btn--primary">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
