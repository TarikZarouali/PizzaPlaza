...
<body class="bg-dark min-height-100vh flex flex-center padding-md">
    <form class="bg radius-md shadow-sm padding-lg max-width-xxs" id="registrationForm" onsubmit="signUp(event)"
        ...
        <div class="margin-bottom-sm">
            <div class="grid gap-xs">
                <div class="col-6@md">
                    ...
                    <input class="form-control width-100%" type="text" name="customerFirstName" id="js-FirstName"
                        placeholder="John">
                </div>

                <div class="col-6@md">
                    <label class="form-label margin-bottom-xxxs" for="customerLastName">Last name</label>
                    <input class="form-control width-100%" type="text" name="customerLastName" id="js-LastName"
                        placeholder="Doe">
                </div>
            </div>
        </div>
        ...
        <div class="margin-bottom-sm">
            ...
            <input class="form-control width-100%" type="email" name="customerEmail" id="js-Email"
                ...
                <div>
                    ...
                    <div class="password js-password ">
                        <input
                            ...
                            type="password" name="customerPassword" id="js-Password" placeholder="password">
        ...
        <div class="margin-bottom-md">
            ...
            <input class="form-control width-100%" type="password" name="customerConfirmPassword"
                id="js-ConfirmPassword" placeholder="confirm password">
        </div>
