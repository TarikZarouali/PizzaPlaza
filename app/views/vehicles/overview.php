                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Vehicles'] as $vehicle) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>vehiclescontroller/update/<?= $vehicle->vehicleId ?>/" class="btn btn--primary">Edit</a>
                                        <a href="<?= URLROOT ?>vehiclescontroller/delete/<?= $vehicle->vehicleId ?>/" class="btn btn--primary">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
