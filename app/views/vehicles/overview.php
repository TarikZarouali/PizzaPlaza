    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/vehiclescontroller/create" class="btn btn--primary">+ New Vehicle</a>
            </div>
        </div>
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            ...
                            <tr class="int-table__row">
                                ...
                                <input type="hidden" name="productId" value="<?= $vehicle->vehicleId ?>">
                                <td class="int-table__cell">
                                    <?= $vehicle->vehicleStoreId ?></td>
                                <td class="int-table__cell">
                                    <?= date('d/m/y', ($vehicle->vehicleMaintenanceDate)) ?></td>
                                <td class="int-table__cell"><?= $vehicle->vehicleType ?></td>
                                <td class="int-table__cell"><?= $vehicle->vehicleIsActive ?></td>
                                <td class="int-table__cell text-truncate max-width-xxxxs">
                                    <?= date('d/m/y', ($vehicle->vehicleCreateDate)) ?>
                                </td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>vehiclescontroller/update/<?= $vehicle->vehicleId ?>/"
                                        class="btn btn--primary">Edit</a>
                                    <a href="<?= URLROOT ?>vehiclescontroller/delete/<?= $vehicle->vehicleId ?>/"
            ...
            <form method="POST" action="<?= URLROOT ?>/vehiclesController/create">
                <div class="grid gap-sm">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control width-100" type="date" name="maintenanceDate" id="maintenance-date"
                            required>
                    </div>
                    <div class="col-12">
