    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <button class="btn btn--primary" aria-controls="modal-new-customer">+ New Ingredient</button>
            </div>
        </div>
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        <thead class="int-table__header js-int-table__header">
                            <tr class="int-table__row">
                                ...
                                <th class="int-table__cell int-table__cell--th int-table__cell--sort js-int-table__cell--sort">
                                    <div class="flex items-center">
                                        <span>Ingredient Createdate</span>
                                </th>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Ingredients'] as $ingredient) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <input type="hidden" name="productId" value="<?= $ingredient->ingredientId ?>">
                                    <td class="int-table__cell">
                                        <?= $ingredient->ingredientName ?></td>
                                    <td class="int-table__cell">
                                        <?= $ingredient->ingredientDescription ?></td>
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>ingredientscontroller/update/<?= $ingredient->ingredientId ?>">Edit</a>
                                    </td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>ingredientscontroller/delete/<?= $ingredient->ingredientId ?>">Delete</a>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
        ...
        <div class="padding-md">
            <form method="POST" action="<?= URLROOT ?>/ingredientsController/create">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-ingredientName">Ingredient Name</label>
                    ...
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-ingredientPrice">Ingredient Price</label>
