    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <button class="btn btn--primary" aria-controls="modal-new-customer">+ New Store</button>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Stores'] as $store) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>storescontroller/update/<?= $store->storeId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>storescontroller/delete/<?= $store->storeId ?>">Delete</a></td>
        ...
        <div class="padding-md">
            <form method="POST" action="<?= URLROOT ?>/storescontroller/create">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-storeStreetName">Street name</label>
