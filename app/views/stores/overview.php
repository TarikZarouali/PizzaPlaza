    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a href="<?= URLROOT ?>/storescontroller/create" class="btn btn--primary">+ New Store</a>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['Stores'] as $store) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell">
                                        <a href="<?= URLROOT ?>storescontroller/update/<?= $store->storeId ?>/" class="btn btn--primary">Edit</a>
                                        <a href="<?= URLROOT ?>storescontroller/delete/<?= $store->storeId ?>/" class="btn btn--primary">Delete</a>
                                    </td>
